...
command <- new SQLiteCommand (feedEntrySql, connection)
command.ExecuteNonQuery |> ignore
...
//
//
//let clientSystem = System.create "client" Client.config
//
////simulation
//
